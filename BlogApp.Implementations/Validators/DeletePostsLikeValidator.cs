...
{
    public class DeletePostsLikeValidator : AbstractValidator<RequestPostsLikeDto>
    {
        private BlogAppDbContext _context;
        public DeletePostsLikeValidator(BlogAppDbContext context)
        {
            _context = context;
            ...
            RuleFor(x => new { postId = x.PostId, userId = x.UserId})
                ...
                .WithMessage("Such like doesn't exist.");
        }
    }
}
